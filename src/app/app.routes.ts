      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './shared/components/general-news/general-news-detalhes/general-news-detalhes.component'
              ).then((c) => c.GeneralNewsDetalhesComponent),
          },
          {
            path: 'acesso-informacao',
            loadComponent: () =>
              import(
                './features/acesso-informacao/acesso-informacao.component'
              ).then((c) => c.AcessoInformacaoComponent),
          },
          {
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/atos-admissionais/atos-admissionais.component'
              ).then((c) => c.AtosAdmissionaisComponent),
          },
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/contratacao-direta/contratacao-direta.component'
              ).then((c) => c.ContratacaoDiretaComponent),
          },
