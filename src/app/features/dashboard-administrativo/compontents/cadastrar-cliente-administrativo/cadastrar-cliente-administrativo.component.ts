...
export class CadastrarClienteAdministrativoComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.clienteForm = this.fb.group({
      ...
      is_active: [true],
      domain: [''],
      previous_official_gazette_link: [''],
      previous_transparent_link:[''],
      previous_official_gazette_date:[''],
  ...
  populaFormulario(clienteData: ExibirClienteData): void {
    this.clienteForm.patchValue({
      ...
      previous_official_gazette_link: clienteData.previous_official_gazette_link,
      previous_transparent_link:clienteData.previous_transparent_link,
      previous_official_gazette_date: clienteData.previous_official_gazette_date,
